...
Put the folder and codes into one folder and  run the python programs in following order:
1. video_loading.py
2. cnn_model.py
3. model_training.py
4. prediction.py (for prediction based on the input video given with the codes)
5. prediction_customPath.py (if you have a custom path for input video)
